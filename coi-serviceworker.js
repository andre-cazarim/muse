...
if (typeof window === 'undefined') {
  ...
  self.addEventListener('fetch', function (event) {
    ...
    // Só precisamos reescrever os cabeçalhos das respostas do PRÓPRIO site
    // (é isso que faz o navegador considerar a página "isolada"). Arquivos
    // de CDN (cross-origin, como os ~30MB do motor de compressão) já chegam
    // com os cabeçalhos de CORS certos — interceptar e reembalar eles aqui
    // só adiciona lentidão desnecessária em downloads grandes, sem necessidade.
    let url;
